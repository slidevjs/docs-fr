...
- Étendre les configurations UnoCSS
- Configurer des outils comme Shiki et Monaco
...
Les couleurs de mise en évidence de la syntaxe sont également fournies dans le thème. Par exemple [`./setup/shiki.ts`](https://github.com/slidevjs/slidev/blob/main/packages/create-theme/template/setup/shiki.ts). Reportez-vous à [la documentation sur la coloration syntaxique](/custom/highlighters) pour plus d'informations.
