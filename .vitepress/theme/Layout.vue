<template>
  <div class="deprecate-banner">
    Cette traduction est obsolète, veuillez consulter le
    <a href="https://sli.dev/">document en anglais</a>.
  </div>

  <div class="theme" :class="pageClasses" style="margin-top:20px;transform:translateX(0)">
    <NavBar
      v-if="showNavbar"
