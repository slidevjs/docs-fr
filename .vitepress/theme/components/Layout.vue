        ...
        <Dropdown :triggers="['hover', 'click']" :popper-triggers="['hover']" theme="twoslash" popper-class="z-1000">
          ...
          <template #popper>
            <div class="p3 text-sm">
              <p>
                Vous regardez la nouvelle documentation de Slidev.
              </p>
              <p>
                L'ancienne documentation est disponible 
                <a href="https://docs-legacy.sli.dev/" class="underline text-primary" target="_blank">ici</a>.
              </p>
            </div>
          </template>
        </Dropdown>
