...
function play() {
  ...
  new TypeIt(block.value!, {
    ...
    .type('Slides de Présentation pour Développeurs', { delay: 400 })
    ...
    .type('- 📄 Écrivez des diapositives dans un seul fichier Markdown<br>', { delay: 800 })
    .type('- 🌈 Thèmes, blocks de code, composants interactifs<br>', { delay: 800 })
